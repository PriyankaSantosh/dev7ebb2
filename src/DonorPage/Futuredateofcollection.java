...
public class Futuredateofcollection
{
	static{
...
@Test
public void Futuredateofcollection() throws InterruptedException
{
	...
	driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys(dd);

			driver.findElement(By.xpath("//input[@id='edit-field-donor-name-und-0-value']")).sendKeys("test");
			...
			*/
			...
			driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("30 Dec 2020");
			...
			System.out.println("Date of Collection should not be of a future date.");
	}
}
