...
public void Deferral()
{
			...
			//	WebDriver driver=new ChromeDriver();
	          ...
	          System.out.println(dd1);
				...
				driver.findElement(By.xpath("//input[@id='edit-field-hemoglobin-test-und-less-than-125']")).click();
				...
				driver.findElement(By.xpath("//input[@id='edit-field-discarded-und-yes']")).click();
				driver.findElement(By.xpath("//input[@id='edit-field-date-of-discard-und-0-value-datepicker-popup-0']")).sendKeys(dd);
				driver.findElement(By.xpath("//select[@id='edit-field-reason-for-discard-und']")).click();
