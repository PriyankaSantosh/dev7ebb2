...
public class noBloodBag {
	static{
		System.setProperty("webdriver.chrome.driver", "./driver/chromedriver.exe");
		}
	WebDriver driver=new ChromeDriver();
@Test
public void noBloodBag()
{
			...
			//	public static void main(String[] args) throws InterruptedException {
				...
				driver.findElement(By.xpath("//input[@id='edit-field-donor-name-und-0-value']")).sendKeys("NoBloodbag");
...
`
				...
				System.out.println("Type of Bag is not set. Please set the type of bag.\r\n" + 
						"Components could not be generated as Components to be Prepared was not provided in donor form");
