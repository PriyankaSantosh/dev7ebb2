...
public class SameReg {
	static{
		System.setProperty("webdriver.chrome.driver", "./driver/chromedriver.exe");
		}
	WebDriver driver=new ChromeDriver();
	@Test
	public void SameReg() throws InterruptedException
	{
	...
	driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys("test21");
			...
			*/
			...
			driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("5 Jun 2019");
			...
			System.out.println("Unable to create the donation record since same Registration id exists");
	}
