...
public class SetBloodBagReg {
	static{
		System.setProperty("webdriver.chrome.driver", "./driver/chromedriver.exe");
		}
	WebDriver driver=new ChromeDriver();
@Test
public void SetBloodBagReg()
{
		...
		//public static void main(String[] args) throws InterruptedException {
			...
			WebElement checking = driver.findElement(By.xpath("//input[@id='edit-field-centre-custom-settings-und-allow-partial-donor-entry']"));
			if (checking.isSelected()) {
			 ...
			 WebElement check1 = driver.findElement(By.xpath("//input[@id='edit-field-centre-custom-settings-und-allow-partial-donor-entry']"));
			 JavascriptExecutor executor211 = (JavascriptExecutor)driver;
			...
			WebElement checking1 = driver.findElement(By.xpath("//input[@id='edit-field-centre-custom-settings-und-set-donor-registration-id-as-blood-bag-number']"));
