...
public class CrossmatchWithExpired {
	static{
		System.setProperty("webdriver.chrome.driver", "./driver/chromedriver.exe");
		}
	WebDriver driver=new ChromeDriver();
	@Test
	public void CrossmatchWithExpired() throws InterruptedException
	{
		...
		// TODO Auto-generated method stub
			...
			driver.findElement(By.xpath("//a[text()='Logout']")).click();
			          ...
			          System.out.println(rr);
						...
						driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("09 Aug 2019");
